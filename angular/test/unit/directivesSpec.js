...
describe('directives', function() {
  ...
  describe('apptitle', function() {
    ...
    beforeEach(inject(function($rootScope, $compile) {
      scope = $rootScope.$new();
      elm = angular.element("<apptitle appl='testapp'>");
      $compile(elm)(scope);
      scope.$digest();
    }));
