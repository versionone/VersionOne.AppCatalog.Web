...
(function() {
  var _, basicAuth, bodyParser, config, cors, createServer, express, handleError, matchesValidationError, mongoose, renderQueryResult, typeIsArray;
  ...
  createServer = function() {
    ...
    mongoose.connect(config.mongoUri, mongoOptions, function(err, db) {
      if (err != null) {
