...
(function() {
  var cors, createServer, express, mongoose, nconf;
  ...
  createServer = function(settings) {
    var app, auth, db, handleError, matchesValidationError, password, renderQueryResult, service, typeIsArray, user;
    ...
    app.get(settings.entryRoute, function(req, res) {
    ...
    app.put(settings.entryRoute, auth, function(req, res) {
      if (req.body == null) {
        return;
      }
