...
(function() {
  var cors, createServer, express, mongoose;
  ...
  createServer = function(settings) {
    var app, db, handleError, matchesValidationError, renderQueryResult, service, typeIsArray;
    ...
    app.put(settings.entryRoute, function(req, res) {
      if (req.body == null) {
        return;
      }
