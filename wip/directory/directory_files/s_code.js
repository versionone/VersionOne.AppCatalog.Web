...
s.linkInternalFilters="javascript:,versionone.com,versionone.net,agilechronicles.com, mkto-go.com, marketo.com"
...
s.campaign=s.getQueryParam('intcmp');
s.campaign=s.getQueryParam('d');

/*
 * END - Plugin: getQueryParam 2.3
 */
...
s.visitorNamespace="versionone"
s.trackingServer="metrics.versionone.com"
s.trackingServerSecure="smetrics.versionone.com"
s.dc=122
